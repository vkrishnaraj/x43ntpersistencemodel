...
@Entity
@Table(name = "Address")
public class TraceAddress implements Serializable {
	...
	private TracePassenger passenger;
	...
	public TracePassenger getPassenger() {
		return passenger;
	}

	public void setPassenger(TracePassenger passenger) {
